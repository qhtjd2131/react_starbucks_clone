...
const Rewards = () => {
  return (
    <RewardsComponent>
      <RewardsContainer>
            <RewardsLogo src="https://image.istarbucks.co.kr/common/img/main/rewards-logo.png" alt="" />
            <RewardsItemWrapper>
                <RewardsInfo>
                    <InfoTitle>스타벅스만의 특별한 혜택, <Strong>스타벅스 리워드</Strong></InfoTitle>
                ...
                <RewardsGift>
                    <GiftDescription>
                    회원 가입 후, 스타벅스 e-Gift Card를 <Strong>"나에게 선물하기"로 구매하시고, 편리하게 등록하세요!</Strong><br />카드를 등록하여 스타벅스 리워드 회원이 되신 후, 첫 구매를 하시면 무료 음료쿠폰을 드립니다!
                    </GiftDescription>
                    <GiftButton>
                        e-Gift Card 선물하기
                    </GiftButton>
